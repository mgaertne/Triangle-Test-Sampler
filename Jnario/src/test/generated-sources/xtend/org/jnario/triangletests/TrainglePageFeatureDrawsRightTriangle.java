...
@Named("Scenario: Draws right triangle")
@SuppressWarnings("all")
public class TrainglePageFeatureDrawsRightTriangle {
  @Test
  @Order(0)
  @Named("When  I enter \"3\", \"4\", \"5\" as side lengths")
  public void whenIEnter345AsSideLengths() {
    try {
        StepArguments _stepArguments = new StepArguments("3", "4", "5");
  ...
  @Test
  @Order(1)
  @Named("Then triangle displays \"Right\" as the triangle type")
  public void thenTriangleDisplaysRightAsTheTriangleType() {
      StepArguments _stepArguments = new StepArguments("Right");
      final StepArguments args = _stepArguments;
