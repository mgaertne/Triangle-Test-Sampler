...
@Named("Scenario: Draws a scalene triangle with floating point values")
@SuppressWarnings("all")
public class TrainglePageFeatureDrawsAScaleneTriangleWithFloatingPointValues {
  @Test
  @Order(0)
  @Named("When  I enter \"4.2\", \"5.6\", \"6.1\" as side lengths")
  public void whenIEnter425661AsSideLengths() {
    try {
        StepArguments _stepArguments = new StepArguments("4.2", "5.6", "6.1");
