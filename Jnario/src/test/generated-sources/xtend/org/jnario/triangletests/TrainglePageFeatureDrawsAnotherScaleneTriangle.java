...
@Named("Scenario: Draws another scalene triangle")
@SuppressWarnings("all")
public class TrainglePageFeatureDrawsAnotherScaleneTriangle {
  @Test
  @Order(0)
  @Named("When  I enter \"2\", \"5\", \"6\" as side lengths")
  public void whenIEnter256AsSideLengths() {
    try {
        StepArguments _stepArguments = new StepArguments("2", "5", "6");
