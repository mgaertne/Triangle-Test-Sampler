...
@Named("Scenario: Notices an invalid triangle with invliad side lengths")
@SuppressWarnings("all")
public class TrainglePageFeatureNoticesAnInvalidTriangleWithInvliadSideLengths {
  @Test
  @Order(0)
  @Named("When  I enter \"1\", \"4\", \"6\" as side lengths")
  public void whenIEnter146AsSideLengths() {
    try {
        StepArguments _stepArguments = new StepArguments("1", "4", "6");
